#########################################################################################
# Sentence-WiseWER Metric Calculator                        
#
#########################################################################################
...
def wer_lines(hyps, refs, outfile):
    netv, netp = 0, 0
    for h, r in zip(hyps, refs):
        ...
        netv += v
        netp += p
    netp = netp / float(len(refs))
    netv = netv / float(len(refs))
    return netv, netp
#########################################################################################
...
if __name__ == '__main__':
    ...
    net_wer = wer_lines(hyps_arr, refs_arr, outfile)   
    print(net_wer)
#########################################################################################
