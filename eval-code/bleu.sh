# BLEU Calculator Script
# First argument is hypothesis
# Second argument is reference
# Third argument is language code

MOSES_PATH="../util-code/moses"

sed -r 's/(@@ )|(@@ ?$)//g' < $1 > $1.words
sed -r 's/(@@ )|(@@ ?$)//g' < $2 > $2.words
python2 scripts/remove_duplicates.py $1.words $1.dedup
...
rm $1.words $1.dedup $1.detrue $1.detok $1.awords $1.bwords $1.cwords $1.dwords $1.ewords $1.fwords $2.words $2.d$
