######################################################################################
 ...
 python -u train.py\
     -data ../../dump/big_noisy_ce_fr/vmf \
     -save_model ../../dump/big_noisy_ce_fr/vmf \
     -layers 6\
     -rnn_size 512\
     -word_vec_size 512\
     -transformer_ff 1024\
 ...
 python -u translate.py\
             -decode_loss cosine\
             -model ../../dump/big_noisy_ce_fr/vmf_step_0000.pt\
             -src ../../data/en-fr-paraphrase-john/trans/fr_eng-test.txt.tok.true.fr\
             -output ../../dump/big_noisy_ce_fr/big/predictions\
             -batch_size 4000\
             -batch_type tokens\
             -beam_size 1\
             -replace_unk\
