...
# PREPROCESS
 ...
 python -u train.py\
     -data ../../dump/ce_joint/vmf \
     -save_model ../../dump/ce_joint/vmf \
     -layers 6 \
     -rnn_size 512\
     -word_vec_size 512\
     -transformer_ff 1024\
 ...
 python -u translate.py\
             -model ../../dump/ce_joint/vmf_step_40000.pt\
             -src ../../data/kumarvon2018-data/fren/gen/trans/en_test.en\
             -output ../../dump/ce_joint/iwslt/en/predictions\
             -batch_size 4000\
             -batch_type tokens\
             -beam_size 1\
             -replace_unk\
 ...
 python -u translate.py\
             ...
             -output ../../dump/ce_joint/iwslt/fr/predictions\
             -batch_size 4000\
             -batch_type tokens\
             -beam_size 1\
             -replace_unk\
