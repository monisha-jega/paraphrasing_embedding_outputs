...
class Translator(object):
    ...
    def __init__(
        ...
        print("<es> index is, ", tgt_field.vocab.stoi["<es>"])
        ...
        if lang == "Fr":
            ...
            start_token = "<es>"
        print("Target language token is ", lang, start_token)
        self._tgt_bos_idx = self._tgt_vocab.stoi[start_token]
